...
describe("GameEngine", () => {
    ...
    it("should return 2000 points for 'the lower street'", () => {
        ...
        const result = processTakeScores(testState.diceStates, testState.currentScore);
    ...
    test("processTakeScores_validSelection", () => {
        ...
        const actual = processTakeScores(validSelectionState.diceStates, validSelectionState.currentScore);
    ...
    test("processFinishMove", () => {
        ...
        const actual = processFinishMove(testState.currentPlayerId, testState.players, testState.currentScore);
        expect(actual).toEqual(expected);
    })
    ...
    test("processInvalidComposition", () => {
        ...
        const actual = processInvalidComposition(testState.currentPlayerId, testState.players);
        expect(actual).toEqual(expected);
    })
